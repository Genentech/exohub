...
// OSS built-ins are empty; Roche built-ins are provided by defaults_roche.go
// (guarded by //go:build roche).
package defaults
...
// Overridden to a Roche URL by defaults_roche.go when built with -tags roche.
var builtinAPIBase = ""
