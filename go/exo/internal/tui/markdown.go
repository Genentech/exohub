...
type markdown struct {
	// ArtifactDB ID to obtain JSON metadata
	ArfifactDBID string
	...
	Terms      []string // Unique search terms extracted from highlights for post-render ANSI highlighting
	Modtime    time.Time

	// Raw content (YAML representation of JSON)
	RawContent string
	// Whether a template is available for markdown rendering
