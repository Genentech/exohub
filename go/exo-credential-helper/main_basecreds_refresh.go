...
// The built-in default is empty for the OSS build; supply via env or a roche overlay.
var cognitoOAuthURL = ""
...
// defaultOIDCClientID is the default OIDC client ID for the !janus build.
// Empty in the OSS base; set by the roche overlay (main_basecreds_refresh_roche.go).
